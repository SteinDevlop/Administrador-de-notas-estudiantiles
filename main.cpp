  ...
  public:
	...
	Estudiante *db;
  	...
  	void importar(){
    	...
    	leerArchivo.open("E:\\Administrador-de-notas-estudiantiles-main\\Administrador-de-notas-estudiantiles-main\\database.txt");
    	...
    	for (int i=0; i<n; i++){
    		...
    		getline(leerArchivo,linea,'|'); db[i].nota_final=atof(linea.c_str());
    		getline(leerArchivo,linea);
		}leerArchivo.close();
  	}
  	void exportar(){
    	ofstream escribirArchivo;
    	escribirArchivo.open("E:\\Administrador-de-notas-estudiantiles-main\\Administrador-de-notas-estudiantiles-main\\database.txt");
    	for (int i=0; i<tam; i++){
